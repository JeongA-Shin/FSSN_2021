        ...
        while True:
            ...
            if(msg.decode()[0]=='s'): #s로 시작하면 stage 정보임
                ...
                if(stage_data['s2']==2): #2 player mode 시작이면
                    ...
                    if((score_data_2[first]-score_data_2[second])>=30): #후반,중계 멘트가 달라질 때만 보낸다.
                    ...
                    elif((score_data_2[first]-score_data_2[second])>=20): #중반
                        ...
                        if(prevment != text2):
                            ...
                            self.publisher.send(json.dumps(relay_info).encode())
                    elif((score_data_3[first]-score_data_3[second])<=10):  #초반
