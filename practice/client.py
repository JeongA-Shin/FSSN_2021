...
class ClientTask(threading.Thread):
        ...
        while True:
            if(self.subscriber.poll(100)&zmq.POLLIN):
                ...
                if('clientNum' in message):
                    ...
                    #print(message['relay_info'])
                    global relay_text
                    relay_text=message['relay_info'] #현재
                elif('third' in message): #3등까지 정보가 있으면
    ...
    def run(self):
        ...
        while running:
            dt=clock.tick(95)#원하는 화면의 초당 프레임 수 설정
        ...
        pygame.time.delay(3000) #3초 정도 대기
